...
var GValue = function () {
    ...
    finalize(this, function (gv) {
        // FIXME verify this does get called correctly
...
GValue.prototype.set = function (value) {
    ...
    case GTYPE.array_int:
        if (!(value instanceof Array)) {
            value = [value];
        }

        var array = new ArrayInt(value);
        libvips.vips_value_set_array_int(this.buffer.ref(), array, value.length);
        break;

    case GTYPE.array_double:
        if (!(value instanceof Array)) {
            value = [value];
        }
...
GValue.prototype.get = function () {
    ...
    case GTYPE.array_int:
        ...
        var array = libvips.vips_value_get_array_int(this.buffer.ref(), len_buf);
    ...
    case GTYPE.blob:
        ...
        var blob = vips.vips_value_get_blob(this.buffer.ref(), size_buf.ref())
