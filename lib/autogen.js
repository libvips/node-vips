...
module.exports = function (vips) {
    ...
    vips.Image.prototype.bandjoin_const = function (c, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.boolean_const = function (boolean, c, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.draw_circle = function (ink, cx, cy, radius, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_circle', this, ink, cx, cy, radius, options);
    };


    vips.Image.prototype.draw_flood = function (ink, x, y, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_flood', this, ink, x, y, options);
    };


    vips.Image.prototype.draw_image = function (sub, x, y, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_image', this, sub, x, y, options);
    };


    vips.Image.prototype.draw_line = function (ink, x1, y1, x2, y2, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_line', this, ink, x1, y1, x2, y2, options);
    };


    vips.Image.prototype.draw_mask = function (ink, mask, x, y, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_mask', this, ink, mask, x, y, options);
    };


    vips.Image.prototype.draw_rect = function (ink, left, top, width, height, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('draw_rect', this, ink, left, top, width, height, options);
    };


    vips.Image.prototype.draw_smudge = function (left, top, width, height, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.dzsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.extract_area = function (left, top, width, height, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('extract_area', this, left, top, width, height, options);
    };


    vips.Image.prototype.extract_band = function (band, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.find_trim = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.fractsurf = function (width, height, fractal_dimension, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('fractsurf', width, height, fractal_dimension, options);
    };
    ...
    vips.Image.gaussmat = function (sigma, min_ampl, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('gaussmat', sigma, min_ampl, options);
    };
    ...
    vips.Image.gifload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.grid = function (tile_height, across, down, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('grid', this, tile_height, across, down, options);
    };


    vips.Image.prototype.hist_cum = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_cum', this, options);
    };


    vips.Image.prototype.hist_entropy = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_entropy', this, options);
    };


    vips.Image.prototype.hist_equal = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_equal', this, options);
    };


    vips.Image.prototype.hist_find = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_find', this, options);
    };


    vips.Image.prototype.hist_find_indexed = function (index, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_find_indexed', this, index, options);
    };


    vips.Image.prototype.hist_find_ndim = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_find_ndim', this, options);
    };


    vips.Image.prototype.hist_ismonotonic = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_ismonotonic', this, options);
    };


    vips.Image.prototype.hist_local = function (width, height, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_local', this, width, height, options);
    };


    vips.Image.prototype.hist_match = function (ref, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_match', this, ref, options);
    };


    vips.Image.prototype.hist_norm = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_norm', this, options);
    };


    vips.Image.prototype.hist_plot = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hist_plot', this, options);
    };


    vips.Image.prototype.hough_circle = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hough_circle', this, options);
    };


    vips.Image.prototype.hough_line = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('hough_line', this, options);
    };


    vips.Image.prototype.icc_export = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('icc_export', this, options);
    };


    vips.Image.prototype.icc_import = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('icc_import', this, options);
    };


    vips.Image.prototype.icc_transform = function (output_profile, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('icc_transform', this, output_profile, options);
    };
    ...
    vips.Image.jpegload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.jpegsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('jpegsave_buffer', this, options);
    };


    vips.Image.prototype.jpegsave_mime = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.logmat = function (sigma, min_ampl, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('logmat', sigma, min_ampl, options);
    };
    ...
    vips.Image.magickload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.mask_butterworth = function (width, height, order, frequency_cutoff, amplitude_cutoff, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_butterworth', width, height, order, frequency_cutoff, amplitude_cutoff, options);
    };


    vips.Image.mask_butterworth_band = function (width, height, order, frequency_cutoff_x, frequency_cutoff_y, radius, amplitude_cutoff, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_butterworth_band', width, height, order, frequency_cutoff_x, frequency_cutoff_y, radius, amplitude_cutoff, options);
    };


    vips.Image.mask_butterworth_ring = function (width, height, order, frequency_cutoff, amplitude_cutoff, ringwidth, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_butterworth_ring', width, height, order, frequency_cutoff, amplitude_cutoff, ringwidth, options);
    };


    vips.Image.mask_fractal = function (width, height, fractal_dimension, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_fractal', width, height, fractal_dimension, options);
    };


    vips.Image.mask_gaussian = function (width, height, frequency_cutoff, amplitude_cutoff, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_gaussian', width, height, frequency_cutoff, amplitude_cutoff, options);
    };


    vips.Image.mask_gaussian_band = function (width, height, frequency_cutoff_x, frequency_cutoff_y, radius, amplitude_cutoff, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_gaussian_band', width, height, frequency_cutoff_x, frequency_cutoff_y, radius, amplitude_cutoff, options);
    };


    vips.Image.mask_gaussian_ring = function (width, height, frequency_cutoff, amplitude_cutoff, ringwidth, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_gaussian_ring', width, height, frequency_cutoff, amplitude_cutoff, ringwidth, options);
    };


    vips.Image.mask_ideal = function (width, height, frequency_cutoff, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_ideal', width, height, frequency_cutoff, options);
    };


    vips.Image.mask_ideal_band = function (width, height, frequency_cutoff_x, frequency_cutoff_y, radius, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_ideal_band', width, height, frequency_cutoff_x, frequency_cutoff_y, radius, options);
    };


    vips.Image.mask_ideal_ring = function (width, height, frequency_cutoff, ringwidth, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('mask_ideal_ring', width, height, frequency_cutoff, ringwidth, options);
    };
    ...
    vips.Image.prototype.math2_const = function (math2, c, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.pdfload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.pngload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.pngsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.radsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.rawsave_fd = function (fd, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.relational_const = function (relational, c, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.remainder_const = function (c, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.svgload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('svgload_buffer', buffer, options);
    };


    vips.Image.system = function (cmd_format, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('system', cmd_format, options);
    };
    ...
    vips.Image.thumbnail_buffer = function (buffer, width, options) {
        options = typeof options !== 'undefined' ? options : {};
        return vips.call('thumbnail_buffer', buffer, width, options);
    };


    vips.Image.prototype.thumbnail_image = function (width, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.tiffload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.tiffsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.webpload_buffer = function (buffer, options) {
        options = typeof options !== 'undefined' ? options : {};
    ...
    vips.Image.prototype.webpsave_buffer = function (options) {
        options = typeof options !== 'undefined' ? options : {};
